#!/usr/bin/env python3
"""
ADRVE Edge Device Script - Optimized for Smooth KVS Streaming
------------------------------------------------------------
...
Usage:
  python edge-device-optimized.py [--profile PROFILE_NAME] [--no-display] [--rtsp-url URL]
...
def start_kvs_producer():
    ...
    try:
        ...
        print(f"KVS parameters: storage-size={KVS_STORAGE_SIZE}, fragment-duration={KVS_FRAGMENT_DURATION}, frame-rate={FPS}")
