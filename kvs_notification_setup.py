...
def lambda_handler(event, context):
    ...
    try:
        ...
        response = kvs_client.create_stream_notification_configuration(
        ...
        notification_id = response.get('NotificationConfiguration', {}).get('NotificationConfigurationId', '')
        logger.info(f"Notification configuration created with ID: {notification_id}")
